...
public class TestData {
    ...
    public static final Set<String> EDGE_4 = new HashSet<>();
    ...
    public static final Set<String> EDGE_2_4_5 = new HashSet<>();
    ...
    static {
        ...
        EDGE_2_4_5.add("INIT-2");
        EDGE_2_4_5.add("INIT-4");
        EDGE_2_4_5.add("INIT-5");
